...
Within the [four-system pipe](AGENT_ECONOMY_ARCHITECTURE.md), the Proof-of-Answer Receipt is the atomic unit that the Contract, Treasury and Settlement Engine escrows against and the Proof and Capability Continuity Network verifies. Independent verification of the underlying evidence is the role [EvidencePipe](EVIDENCEPIPE.md) plays.
